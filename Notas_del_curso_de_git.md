...
:~$ git push origin :<Nombre de la rama>
        <p>Enviar ramas a el repositorio remoto</p>
- :~$ git push origin <Nombre de la rama>
...
- :~$ git merge
        <p>Para unir las ramas</p>
        <li>Cuando existe un conflicto. aparecen estos comentarios en el codigo:
        <<<<<<<HEAD
        ...
        Guardar archivo
        Hay que volver hacer commit</li>
- :~$ git merge <nombre de la rama>
        <p>Para abortar un merge o revertir hay que invocar.</p>
- :~$ git merge --abort
    ### Para generar una nueva rama
- :~$ git branch <nombre de la rama>
        <p>Para borrar una rama.</p>
- :~$ git branch -d <Nombre de la rama>
        <p>Forzar el barrar rama. Tal ves se necesite forzar en caso de que la rama tenga trabaos sin fusionar</p>
- :~$ git branch -D <Nombre de la rama>
        <p>Nos muestra el historial de todas las ramas a detalle</p>
- :~$ git show-branch --all
